  ...
  it: {
    ...
    services: {
      ...
      sections: {
        ...
        instantWebsites: {
          title: 'Siti Istantanei',
          description: 'Il tuo sito in 7 giorni: struttura e copy sono generati sulla base dei veri intenti di ricerca del tuo pubblico.',
          features: [
            'Sito online in 7 giorni',
            'Copy generato da dati reali (IA)',
            'Supporto e hosting per 12 mesi',
            'Ottimizzazione SEO predittiva'
          ]
        },
        whatsapp: {
          title: 'Contattaci su WhatsApp',
          description: 'Inviaci un messaggio o un vocale per una consulenza guidata dai dati.',
          features: [
            'Risposta in tempo reale con AI',
            'Invio di messaggi vocali',
            'Analisi immediata dei bisogni',
            'Disponibilità 7/24'
          ]
        },
        landingPageProfessionali: {
          title: 'Landing Page Professionali',
          description: 'Aumenta le conversioni con landing page ottimizzate dove struttura e testi sono validati da strumenti di intelligenza artificiale.',
          features: [
            'Copy e design AI-tested',
            'Hosting e integrazioni inclusi',
            'Ottimizzazione A/B testing',
            'Pronta in 5 giorni lavorativi'
          ]
        },
        rispondiSubito: {
          title: 'RispondoSubito',
          description: 'Realizziamo risponditori evoluti (AI Voice / Chat) per qualificare ogni lead senza costi operatore.',
          features: [
            'Assistenza intelligente H24',
    ...
    services: {
      ...
      sections: {
        ...
        instantWebsites: {
          ...
          description: 'Your site in 7 days: structure and copy are generated based on the true search intents of your audience.',
          features: [
            'Website online in 7 days',
            'AI-generated copy from real data',
            'Support and hosting for 12 months',
            'Predictive SEO optimization'
          ]
        },
        whatsapp: {
          title: 'Contact us on WhatsApp',
          description: 'Send us a message or voice note for a data-driven consultation.',
          features: [
        ...
        landingPageProfessionali: {
          ...
          description: 'Increase conversions with optimized landing pages where structure and texts are validated by AI tools.',
          features: [
            'AI-tested copy and design',
            'Hosting and integrations included',
        ...
        rispondiSubito: {
          title: 'RispondoSubito',
          description: 'We build advanced responders (AI Voice/Chat) to qualify every lead without operator costs.',
          features: [
